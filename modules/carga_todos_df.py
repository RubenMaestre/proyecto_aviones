...
@st.cache_data
def cargar_todos_df():
    # Define los años y la cantidad de archivos Parquet por año
    anios = {
        '2023': 2,
        '2022': 2,
        '2021': 2
    ...
    if 'df_todos' not in st.session_state:
        ...
        # Iterar sobre cada año y cargar cada archivo Parquet correspondiente
        for anio, num_archivos in anios.items():
            for i in range(1, num_archivos + 1):
                archivo = f'data/parquet/df_{anio}_{i}.parquet'
